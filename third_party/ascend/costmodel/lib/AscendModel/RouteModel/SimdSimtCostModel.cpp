...
static void readStageResources(ProfileJSONReader &reader,
  ...
  if (const auto *scalarMemory =
    ...
    profile.scalarLoadLatencyCycles = reader.number(
        *scalarMemory, "load_latency_system_cycles", path);
    profile.scalarStoreLatencyCycles = reader.number(
        *scalarMemory, "store_latency_system_cycles", path);
    ...
    profile.mainScalarLoadPrepCycles = reader.optionalNumber(
        *scalarMemory, "main_load_prep_system_cycles",
        profile.mainScalarLoadPrepCycles);
    profile.mainScalarLoadFillCycles = reader.optionalNumber(
        *scalarMemory, "main_load_fill_system_cycles",
        profile.mainScalarLoadFillCycles);
    profile.mainScalarLoadHitCycles = reader.optionalNumber(
        *scalarMemory, "main_load_hit_system_cycles",
        profile.mainScalarLoadHitCycles);
    profile.mainScalarLoadIssueCycles = reader.optionalNumber(
        *scalarMemory, "main_load_issue_system_cycles",
        profile.mainScalarLoadIssueCycles);
    profile.simtUniformLoadPrepCycles = reader.optionalNumber(
        *scalarMemory, "uniform_load_prep_system_cycles",
        profile.simtUniformLoadPrepCycles);
    profile.simtUniformLoadFillCycles = reader.optionalNumber(
        *scalarMemory, "uniform_load_fill_system_cycles",
    ...
    profile.mainScalarLoadOutstandingLines = reader.optionalNumber(
        *scalarMemory, "main_load_outstanding_line_count",
    ...
    profile.mte3StorePrepCycles = reader.optionalNumber(
        *scalarMemory, "mte3_store_prep_system_cycles",
        profile.mte3StorePrepCycles);
    profile.mte3StoreFillCycles = reader.optionalNumber(
        *scalarMemory, "mte3_store_fill_system_cycles",
        profile.mte3StoreFillCycles);
    profile.mte3StoreSerialCycles = reader.optionalNumber(
        *scalarMemory, "mte3_store_serial_system_cycles",
    ...
    if (reader.failed())
      return;
    profile.scalarLoadCyclesFit = reader.optionalNumberArray(
        *scalarMemory, "load_cycles_fit");
    profile.scalarStoreCyclesFit = reader.optionalNumberArray(
        *scalarMemory, "store_cycles_fit");
  }
