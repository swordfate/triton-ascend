...
cd ${CUR_PATH}
rm -rf github_mojo_opset_950perf
source /data/set_proxy.bash
git config --global http.sslverify false
git clone -b hw/950-perf https://github.com/XPU-Forces/mojo_opset.git github_mojo_opset_950perf
cp test_attention_testcases.py ./github_mojo_opset_950perf/mojo_opset/tests/accuracy/functions/
#cp run_mojo_accuracy_test.sh ./mojo_opset/
#cp testcase_a3.txt ./mojo_opset/
cd ./github_mojo_opset_950perf
pip install -e .
pip install transformers==5.3.0
pip install einops
pip install pydantic

LIST_FILE=${CUR_PATH}/testcase_github.txt
...
OP_LOG_DIR="${TEST_DIR}/logs/github_mojo_opset_950perf"
...
# run gene case
TEST_generalization="${CUR_PATH}/github_mojo_opset_950perf"
