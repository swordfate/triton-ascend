# Source: Q2TritonKernel/src/kernels/activation/swiglu.py
...
from kernels.q2tritonkernel.utils import VEC_ALIGN_BYTES
from kernels.q2tritonkernel.utils import align
from kernels.q2tritonkernel.utils import get_num_vectorcore
...
def swiglu_fwd_impl(
    ...
    num_programs = get_num_vectorcore()
    grid = (num_programs,)
