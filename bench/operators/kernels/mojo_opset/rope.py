# Source: mojo_opset/mojo_opset/backends/ttx/kernels/npu/a2/rope.py
...
from kernels.mojo_opset.kern_utils import prepare_lens
from kernels.mojo_opset.kern_utils import tensor_cache
