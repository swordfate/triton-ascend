# Source: mojo_opset/mojo_opset/backends/ttx/kernels/npu/a2/rmsnorm.py
...
from kernels.mojo_opset.npu.utils import VEC_ALIGN_BYTES
from kernels.mojo_opset.kern_utils import align
from kernels.mojo_opset.kern_utils import ceil_div
from kernels.mojo_opset.kern_utils import torch_to_triton_dtype
import os as _os; get_bool_env = lambda name, default=False: _os.environ.get(name, str(default)).lower() in ("1", "true", "yes")
