# Source: mojo_opset/mojo_opset/backends/ttx/kernels/npu/a2/fused_add_rmsnorm.py
...
from kernels.mojo_opset.npu.utils import VEC_ALIGN_BYTES, get_num_cores
from kernels.mojo_opset.kern_utils import align, ceil_div
