#!/usr/bin/env python3
"""Benchmark sdpa: costmodel vs brute-force autotune.

Source: mojo_opset/backends/ttx/kernels/npu/sdpa.py
"""
...
def main():
    ...
    from kernels.mojo_opset.a5 import sdpa as mod_a
    ...
    from kernels.mojo_opset.a5 import sdpa as mod_b
    ...
    with open(os.path.join(os.path.dirname(__file__), "results_sdpa.json"), "w") as f:
        json.dump({"operator": "sdpa", "top_k": TOP_K, "speedup": b_elapsed / a_elapsed if a_elapsed else float("inf")}, f, indent=2)
    print("Results saved")
