#!/usr/bin/env python3
"""Benchmark gelu: costmodel vs brute-force autotune.

Source: mojo_opset/backends/ttx/kernels/npu/gelu.py
"""
...
def main():
    ...
    with open(os.path.join(os.path.dirname(__file__), "results_gelu.json"), "w") as f:
        json.dump({"operator": "gelu", "top_k": TOP_K, "speedup": b_elapsed / a_elapsed if a_elapsed else float("inf")}, f, indent=2)
    print("Results saved")
