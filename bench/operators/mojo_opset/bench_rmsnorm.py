#!/usr/bin/env python3
"""Benchmark rmsnorm: costmodel vs brute-force autotune.

Source: mojo_opset/backends/ttx/kernels/npu/rmsnorm.py
"""
...
def main():
    ...
    from kernels.mojo_opset.a5 import rmsnorm as mod_a
    ...
    from kernels.mojo_opset.a5 import rmsnorm as mod_b
    ...
    with open(os.path.join(os.path.dirname(__file__), "results_rmsnorm.json"), "w") as f:
        json.dump({"operator": "rmsnorm", "top_k": TOP_K, "speedup": b_elapsed / a_elapsed if a_elapsed else float("inf")}, f, indent=2)
    print("Results saved")
